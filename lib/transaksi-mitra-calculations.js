 ...
 * Dana ini adalah biaya CB yang dibayar melalui alur Dana Trip, bukan
 * potongan tambahan dari hak mitra pada kwitansi.
 */
...
export function kalkulasiTransaksiMitra(row, hargaPabrikOverride, feeOwnerOverride) {
  ...
  const marginArmadaSetelahDanaTrip = sewaArmadaTotal - danaOperasionalTrip;
