...
| Field | Nilai |
| --- | --- |
| Status | Implemented, locally verified, and rehearsed on isolated staging; hosted Auth, restore drill, and independent review remain pending |
| Branch / baseline SHA | `agent/p0-security-release-gates` / `48499823738482be3f35ce6e5b5060a0bc51342b` plus the final migration documented here |
